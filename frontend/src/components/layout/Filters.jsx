...
const Filters = () => {
    ...
    //if the value in the query's checkbox is the same as the category checkbox
    //we will return true
    //so when we refresh the page , the tick in the checkbox will still be there
