...
const ProductDetails = () => {
  ...
  // increase the quantity by 1, up to the product's stock amount
  const increaseQty = () => {
    const count = document.querySelector(".count");

    if(count.valueAsNumber >= product?.stock) //check whether the value inserted is more than stock amount
    {
      return ;
    }
  ...
  const decreaseQty = () => {
    ...
    if(count.valueAsNumber <= 1) // check if the value of the stock is more than 1
    {
      return ;
    }
